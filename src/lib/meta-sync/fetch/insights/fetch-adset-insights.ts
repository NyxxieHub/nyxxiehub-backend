...
export async function fetchAdSetInsights(
  ...
  const url = `https://graph.facebook.com/v19.0/act_${adSetId}/insights?fields=${fields}&time_range[since]=${since}&time_range[until]=${until}&time_increment=1&limit=25&access_token=${tokenRecord.access_token}`;
